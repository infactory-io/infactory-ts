...
describe('IntegrationsClient', () => {
  ...
  // Test Cosmos DB Integration Methods
  describe('testCosmosConnection', () => {
    it('should call the correct endpoint to test a Cosmos DB connection', async () => {
      const connectionDetails = {
        endpoint: 'https://cosmosdb.example.com',
        key: 'test-key',
      ...
      const result =
        await integrationsClient.testCosmosConnection(connectionDetails);
  ...
  describe('validateCosmosQuery', () => {
    it('should call the correct endpoint to validate a Cosmos DB query', async () => {
      const params = {
        endpoint: 'https://cosmosdb.example.com',
        key: 'test-key',
        databaseName: 'test-db',
      ...
      const result = await integrationsClient.validateCosmosQuery(params);
  ...
  describe('extractCosmosParameters', () => {
    it('should call the correct endpoint to extract parameters from a Cosmos DB query', async () => {
      const query = 'SELECT * FROM c WHERE c.category = @category';
      const mockResponse = {
        parameters: [{ name: 'category', value: '' }],
        parsedQuery: 'SELECT * FROM c WHERE c.category = @category',
      };
      ...
      const result = await integrationsClient.extractCosmosParameters(query);
  ...
  describe('sampleCosmosContainers', () => {
    it('should call the correct endpoint to sample Cosmos DB containers', async () => {
      const params = {
        endpoint: 'https://cosmosdb.example.com',
        key: 'test-key',
        databaseName: 'test-db',
      ...
      const result = await integrationsClient.sampleCosmosContainers(params);
  ...
  describe('executeCosmosQuery', () => {
    it('should call the correct endpoint to execute a Cosmos DB query', async () => {
      const params = {
        endpoint: 'https://cosmosdb.example.com',
        key: 'test-key',
        databaseName: 'test-db',
      ...
      const result = await integrationsClient.executeCosmosQuery(params);
