...
describe('Settings Management E2E Tests', () => {
  ...
  test('1. Update Organization General Settings', async () => {
    ...
    console.log(`Successfully updated organization name to: ${newOrgName}`);
  ...
  test.skip('2. Invite Team Member', async () => {
    ...
    console.log('Skipping invite team member test as it is not implemented');
  });
  ...
  test.skip('5. Remove Team Member', async () => {
    // Not implemented - skipping
    console.log('Skipping remove team member test as it is not implemented');
  });
  ...
  test.skip('9. Cancel Subscription', async () => {
    // Not implemented - skipping
    console.log('Skipping cancel subscription test as it is not implemented');
  });
});
