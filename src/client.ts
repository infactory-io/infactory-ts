...
interface RequestArgsNoBody<T> {
  params?: Record<string, any>;
  options?: RequestInit;
}

interface RequestArgs<T> extends RequestArgsNoBody<T> {
  body?: T;
}
...
export async function getStream<U = any>(
  endpoint: string,
  args: RequestArgsNoBody<U> = {}
) {
