...
export type CreateOrganizationParams = Pick<Organization, 'name' | 'description' | 'platformId' | 'clerkOrgId'>;
...
export class OrganizationsClient {
     ...
     */
    async create(params: CreateOrganizationParams): Promise<ApiResponse<Organization>> {
     ...
     */
    async update(id: string, params: Partial<CreateOrganizationParams>): Promise<ApiResponse<Organization>> {
     ...
     */
    async move(id: string, newPlatformId: string): Promise<ApiResponse<Organization>> {
