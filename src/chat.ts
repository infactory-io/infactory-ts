...
import { del, get, patch, post, postStream } from './client';
  ...
  while (true) {
    ...
    for (const line of lines) {
      ...
      if (line.startsWith('data: ')) {
        ...
        try {
          status_data = JSON.parse(dataStr) as any;
...
export const chatApi = {
  ...
  getProjectConversations: async (
    ...
    return get<Conversation[]>(`/v1/chat`, {
      params: params
    });
  },
  ...
  getConversation: async (
    ...
    return get<Conversation>(`/v1/chat/${conversationId}`);
  },
  ...
  createConversation: async (
    ...
    return post<Conversation>('/v1/chat', {
      body: {
  ...
  getConversationGraph: async (
    ...
    return get<ConversationGraph>(`/v1/chat/${conversationId}/graph`);
  },
  ...
  updateConversation: async (
    ...
    return patch<Conversation>(`/v1/chat/${conversationId}`, {
      body: params
    });
  },
  ...
  archiveConversation: async (
    ...
    return patch<Conversation>(`/v1/chat/${conversationId}/archive`);
  },
  ...
  deleteConversation: async (
    ...
    return del<void>(`/v1/chat/${conversationId}`);
  }
};
